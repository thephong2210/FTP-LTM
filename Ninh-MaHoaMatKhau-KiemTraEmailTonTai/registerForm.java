...
public class registerForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jDateChooser_ngaysinh.getDate() == null) {
            ms += "Ngày sinh chưa điền ";
        }

        try {
            if (checkUsernameExists(jTextField_username.getText()) == false) {
        ...
        if (!ms.equals("")) {
            ...
            String username, pass = null, hoten, gioitinh, ngaysinh;
            username = jTextField_username.getText();

            //Mã hóa pass khi đăng ký
            try {
                pass = MaHoaMatKhau(jTextField_pass.getText());
    ...
    String MaHoaMatKhau(String password) throws NoSuchAlgorithmException {
    ...
    public static boolean checkUsernameExists(String username) throws FileNotFoundException {
